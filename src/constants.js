...
const EXAMPLE_15 = `This is example Metrics insights query to find top 20 avg metric of memory utilazation from ecs service group by cluster name. 'SELECT AVG(memory_utilization) FROM "AWS/ECS" GROUP BY cluster_name ORDER BY AVG() DESC LIMIT 20'`
